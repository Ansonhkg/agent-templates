...
const paths = ["install", "src", "demo", "tests", "e2e", "scripts", ".github", ".gitignore", "package.json", "package-lock.json", "tsconfig.json", "vite.config.ts", "playwright.config.ts", "index.html", "README.md", "INTEGRATION.md", "SECURITY.md", "CONTRIBUTING.md", "RELEASE.md", "VALIDATION.md"];
